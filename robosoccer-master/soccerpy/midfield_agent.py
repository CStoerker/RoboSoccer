...
#############################################################################################
	...
	def dribble(self):
		...
		if self.wm.is_ball_kickable():
		    ...
		    # move towards ball
		    if -7 <= self.wm.ball.direction <= 7 and self.wm.euclidean_distance(self.wm.abs_coords,self.goal_pos) <= 75 and self.wm.euclidean_distance(self.wm.abs_coords,self.goal_pos) >= 47:
			self.wm.ah.dash(65)
			return True
		    else:
			# face ball
